        ...
        <tr>
            ...
            <td style="display: inline-flex">
                ...
                <form action="/student/{{$student->id}}" method="POST">
                    ...
                    <button class="btn action_button action_button_margin"><i class="far fa-trash-alt fa-2x" style="color: red"></i></button>
                </form>
                ...
                <a href="/student/unarchive/{{$student->id}}"><button class="btn action_button action_button_margin">
