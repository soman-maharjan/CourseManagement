...
<form method="POST" action="/staff">
    ...
    <div class="form-row">
        <div class="form-group col-md-4">
            ...
            <input type="text" class="form-control" id="first_name" name="first_name" placeholder="e.g. Soman" value="{{old('first_name')}}">
            @error('first_name')
        ...
        <div class="form-group col-md-4">
            ...
            <input type="text" class="form-control" id="last_name" name="last_name" placeholder="e.g. Maharjan" value="{{old('last_name')}}">
            @error('last_name')
            <p style="color: red">{{ $message }}</p>
            @enderror
        </div>
