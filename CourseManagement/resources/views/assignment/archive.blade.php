...
@section('content')
    ...
    @endif
    <h4>ARCHIVED ASSIGNMENT RECORDS (Click <i class="far fa-file-archive " style="color: black"></i> to unarchive.)</h4>

    <div>
        <a href="/assignment"><button class="btn btn-dark create-button">View UnArchieved Records</button></a>
    </div>
                ...
                @foreach ($assignments as $assignment)
                    <tr>
                        ...
                        <td style="display: inline-flex">
                            ...
                            <a href="/assignment/unarchive/{{ $assignment->id }}"><button
                                    class="btn action_button action_button_margin">
